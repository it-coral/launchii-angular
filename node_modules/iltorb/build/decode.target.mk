...
OBJS := \
	...
	$(obj).target/$(TARGET)/src/dec/decode_index.o \
...
$(obj).target/decode.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/decode.node: LIBS := $(LIBS)
$(obj).target/decode.node: TOOLSET := $(TOOLSET)
$(obj).target/decode.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/decode.node
# Add target alias
.PHONY: decode
decode: $(builddir)/decode.node

# Copy this to the executable output path.
$(builddir)/decode.node: TOOLSET := $(TOOLSET)
$(builddir)/decode.node: $(obj).target/decode.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/decode.node
# Short alias for building this executable.
.PHONY: decode.node
decode.node: $(obj).target/decode.node $(builddir)/decode.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/decode.node
